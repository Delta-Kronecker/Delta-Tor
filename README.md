...
1. Start DeltaTor and wait for 100% bootstrap.
2. Open V2rayN and add a new server with this address:
   ```
   socks://Og@127.0.0.1:9050#DeltaTor
   ```
3. Select the DeltaTor server and enable **Tun** mode.

V2rayN will create a virtual network interface that captures all system
traffic and sends it through DeltaTor's SOCKS5 proxy (127.0.0.1:9050).
